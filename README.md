...
| GET     | `/api/v1/workouts/{id}`                     | Yes | Get session by ID                                                         |
| DELETE  | `/api/v1/workouts/{id}`                     | Yes | Delete session by ID                                                      |
| PUT     | `/api/v1/workouts/{sessionId}/entries/{id}` | Yes | Update entry in session                                              |
| DELETE  | `/api/v1/workouts/{sessionId}/entries/{id}` | Yes | Delete entry from session                                            |
